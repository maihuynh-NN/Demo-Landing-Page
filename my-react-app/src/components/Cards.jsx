    ...
    <div className='bg-white px-4 py-[10rem] w-full'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
            <div className='w-full shadow-xl flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300'>
                <img className='bg-white mx-auto mt-[-3rem] w-20' src={Single} alt="/" />
            ...
            <div className='w-full bg-gray-100 shadow-xl flex flex-col py-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
                <img className='bg-white mx-auto mt-[-3rem] w-20 bg-transparent' src={Double} alt="/" />
                <h2 className='text-2xl font-bold text-center py-8'>Single User</h2>
                <p className='font-bold text-4xl text-center'>$149</p>
                <div className='text-center font-bold '>
                    <p className='py-2 border-b mx-8 mt-8'>500 GB Storage</p>
            ...
            <div className='w-full shadow-xl flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300'>
                <img className='bg-white mx-auto mt-[-3rem] w-20' src={Triple} alt="/" />
                <h2 className='text-2xl font-bold text-center py-8'>Single User</h2>
                <p className='font-bold text-4xl text-center'>$149</p>
                <div className='text-center font-bold '>
                    <p className='py-2 border-b mx-8 mt-8'>500 GB Storage</p>
